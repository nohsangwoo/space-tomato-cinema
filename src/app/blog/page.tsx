...
import { getPublishedPosts, hasBlogDatabaseConnection } from "@/lib/blog/db";
import { company, siteKeywords, siteUrl } from "@/lib/site";

export const dynamic = "force-dynamic";

export function generateMetadata(): Metadata {
  const hasDatabase = hasBlogDatabaseConnection();
    ...
    <main className="blog-page">
      ...
      <section className="blog-index-list" aria-label="블로그 글 목록">
        ...
        {postsResult.ok ? (
          ...
          <BlogUnavailableCard reason={postsResult.reason} />
        )}
      </section>
